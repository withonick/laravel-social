...
<head>
    ...
    <script src="{{asset('https://kit.fontawesome.com/4f0419f35e.js')}}" crossorigin="anonymous"></script>
        ...
        <div class="col-sm-4 side">
            <div class="side-one">
                ...
                <div class="row sideBar">
                    @foreach($users as $u)
                        <a href="{{route('messenger.show', $u->id)}}">
                            <div class="row sideBar-body">
                                <div class="col-sm-3 col-xs-3 sideBar-avatar">
                                    <div class="avatar-icon">
                                        <img src="{{$u->profile_img}}">
                                    </div>
                                </div>
                                <div class="col-sm-9 col-xs-9 sideBar-main">
                                    <div class="row">
                                        <div class="col-sm-8 col-xs-8 sideBar-name">
                  <span class="name-meta">{{$u->firstname . " " . $u->surname}}
                      @if($u->verified)
